...
import {
    LinkForm,
    LinksForm,
} from "@/app/dashboard/(main)/_components/links/LinksList";
...
const LinkMainCard = ({ value, index, handle, onDelete }: Props) => {
    ...
    return (
        <Card
            className={
                "flex h-[90px] min-h-[90px] md:min-h-[100px] md:h-[100px] py-0"
            }
        >
            <CardContent className={"flex w-full py-0 !pl-0 pr-3"}>
                <div
                    {...handle}
                    className={
                        "flex items-center justify-center h-full min-w-9 text-foreground-secondary hover:text-foreground cursor-pointer transition-all"
                    }
                >
                ...
                <div
                    className={
                        "flex flex-col items-center justify-center h-full gap-y-1"
                    }
                >
                    <Switch
                        checked={isEnabled}
                    ...
                    <IconButton
                        size={"lg"}
                        className={
                            "text-foreground-secondary h-[35px] w-[35px]"
                        }
...
export const LinkMainCardSkeleton = () => {
    return (
        <Card
            className={
                "flex min-h-[90px] h-[90px] md:min-h-[100px] md:h-[100px] py-0"
            }
        >
            <CardContent
                className={
