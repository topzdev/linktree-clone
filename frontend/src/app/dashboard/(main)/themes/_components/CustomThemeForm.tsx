                ...
                <FormProvider {...methods}>
                    ...
                    >
                        ...
                        <div className="col-span-12 grid grid-cols-12 gap-3 md:gap-4">
                            <ThemeFormField
                                defaultBgImage={value.bg_image_url}
                                defaultBgVideo={value.bg_video_url}
                                control={control}
                                bg_id={getValues("bg_id")}
                            />
                        </div>
...
const ThemeFormField = ({
    ...
    switch (bg_id) {
        ...
        default:
            return (
                <div key={"bg_color"} className="col-span-12 sm:col-span-6">
                    <FormColorPicker
                        control={control}
                        name={"bg_color"}
        ...
        case 2:
            return (
                <>
                    <div key={"bg_from"} className="col-span-12 sm:col-span-6">
                        <FormColorPicker
                            control={control}
                            name={"bg_from"}
                    ...
                    <div key={"bg_to"} className="col-span-12 sm:col-span-6">
                        <FormColorPicker
                            control={control}
                            name={"bg_to"}
        ...
        case 3:
            return (
                <div key={"bg_image"} className="col-span-12">
                    <FormFilePicker
                        defaultValue={defaultBgImage as string}
                        accept={"image/*"}
                        control={control}
                        name={"bg_image"}
                        label={"Upload Image"}
        ...
        case 4:
            return (
                <div key={"bg_video"} className="col-span-12">
                    <FormFilePicker
                        defaultValue={defaultBgVideo as string}
                        accept={"video/*"}
                        control={control}
                        name={"bg_video"}
                        label={"Upload Video"}
