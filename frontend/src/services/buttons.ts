...
import { ButtonForm } from "@/app/dashboard/(main)/appearance/_components/buttons/ButtonsForm";

const basePath = "/buttons";

export type UpdateButtonsSettings = Pick<
    AppearanceSettings,
    "btn_color" | "btn_text_color" | "btn_shadow_color" | "btn_id"
>;

export type ReturnButtonsSettings = Pick<
    AppearanceSettings,
    | "id"
    | "btn_id"
    | "user_id"
