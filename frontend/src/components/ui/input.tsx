...
export const inputStyling = ({ error }: Pick<InputProps, "error">) => {
    return [
        "flex border border-border bg-input w-full rounded-2xl px-3.5 md:px-5 py-3 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-400 disabled:cursor-not-allowed disabled:opacity-50 text-sm md:text-base",
