    ...
    <DialogPortal>
        ...
        >
            ...
            {(back || leftAction) && (
                <div
                    className={
                        "absolute left-2 lg:left-3 md:left-4 top-2 lg:top-3 md:top-4 "
                    }
                >
                    {leftAction ? (
                        leftAction
                        ...
                        <IconButton
                            color={"accent"}
                            onClick={back}
                            className={"ml-auto !mt-0 text-3xl"}
                        >
            ...
            <DialogPrimitive.Close className="absolute right-2 lg:right-3 md:right-4 top-2 lg:top-3 md:top-4 rounded-sm ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground">
                <IconButton
                    color={"accent"}
                    asChild
                    size="sm"
                    className={"ml-auto !mt-0 text-2xl"}
                >
